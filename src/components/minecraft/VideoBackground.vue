...
<template>
  <div
    class="video-background relative geist flex flex-col items-center justify-center h-dvh w-dvw overflow-hidden"
  >
    <video
      v-if="!isMobile"
    ...
    <div
      v-else
      class="absolute -z-1 bg-[url('/minecraft/background.webp')] bg-cover h-dvh w-dvw"
